  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='flex gap-2'>
        <input onChange={(e)=>setNewSkill(e.target.value)} type='text' 
        value={newSkill} onKeyDown={handleKeyPress}placeholder='enter a skill'className='flex-1 px-3 py-2 text-sm' 
        />
      ...
      <div className='bg-blue-50 p-3 rounded-lg'>
        <p className='text-sm text-blue-800'><strong>Tip:</strong>Add 8-12 relevant skills.Include both technical skills and soft skills.</p>
      </div>
    </div>
  )
}
