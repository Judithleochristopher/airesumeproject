...
const TemplateSelector = ({selectedTemplate, onChange}) => {
    ...
    const templates = [
        ...
        },
        {
            id: 'modern',
            name: 'Modern',
            preview: "A contemporary design featuring bold headings, vibrant colors, and a dynamic layout."

        },
        {
            id: 'minimal',
            name: 'Minimal',
            preview: "A sleek and simple design focusing on essential information with ample white space."
        },
        {
            id: 'minimal-image',
